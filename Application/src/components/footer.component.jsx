    ...
    return (
        <>
            <div className="d-flex flex-column px-3  align-items-center font-linkk" style={{backgroundColor : "#dadada"}}><br />
                ...
                <div className="d-flex align-items-center gap-1"><GiPencil className="fs-2" /><a href="https://github.com/aryasoni98/AI-Interview/tree/master/Application/src" target="_blank">Edit this page</a></div> <div className="d-flex align-items-center gap-1"> <FaCode className="fs-2" /><a href="https://github.com/aryasoni98/AI-Interview/tree/master/Application"  text-dark target="_blank">View Source Code</a></div></div>
                ...
                <div className="d-flex align-items-center gap-4 mb-4">
                    ...
                    <div className="d-flex align-items-center gap-1"><FaDiscord className="fs-2" /><a href="https://discord.com/invite/Je3PHcMRT9" target="_blank" text-dark >Join our Discussions</a></div>
